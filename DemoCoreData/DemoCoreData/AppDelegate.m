...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // Set up our Root View Controller and add it to the main window
    RemindersTableViewController *root = [[RemindersTableViewController alloc] initWithStyle:UITableViewStylePlain];
